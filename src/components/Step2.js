	...
	constructor(props) {
		...
		this.state = {
			messages: [
				...
				`I learned React in 2016, while working under <a href="https://www.linkedin.com/in/dmackinnon" target="_blank">Don Mackinnon</a>, one of the leaders in the Denver React community, and I've been loving it ever since. Not to say I didn't love the old trustworthy imperative jQuery before :) <br>`,
